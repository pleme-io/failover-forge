...
rec {
  ...
  internal = rec {
    ...
    crates = {
      ...
      "drill-core" = rec {
        crateName = "drill-core";
        version = "0.1.0";
        edition = "2024";
        workspace_member = null;
        src = pkgs.fetchgit {
          url = "https://github.com/pleme-io/drill-core";
          rev = "b76536b27ba3adbe2a40ffab3102189432207cb3";
          sha256 = "1n82l4rkrgmwh1x7gaax3363crrzw6ziyak4jyk3wp1gzk9yqfgs";
        };
        libName = "drill_core";
        dependencies = [
          {
